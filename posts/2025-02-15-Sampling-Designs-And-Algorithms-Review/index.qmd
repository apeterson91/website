...
sampling *without* replacement. However, if $n$ is small relative to $N$ then 
the $\pi_{ij}$ in this design will approach its independent counterpart.
