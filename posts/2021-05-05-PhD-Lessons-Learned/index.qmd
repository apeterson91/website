...
description: "A few lessons learned along the way in completing my PhD"
author: 
 - name: "Adam Peterson"
date: "2021-05-05"
image: banner.png
...
Few different layers here worth exploring (1) Personal Attitude (2) Approach to Problem, or Research Philosophy and (3) Statistical Philosophy.
...
For making other packages: \* [usethis](https://usethis.r-lib.org/) \* [devtools](https://devtools.r-lib.org/) (including roxygen2, etc.) \* [renv](https://rstudio.github.io/renv/articles/renv.html) - can also be useful for analyses potentially
