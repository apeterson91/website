...
description: "A parameter collapses, a sophisticated model looms afoot and we find the start of a trail of clues in this unexpected mystery."
author:
 - name: "Adam Peterson"
date: "2019-12-01"
image: banner.png
categories: ["PhD Posts", "Dirichlet Process", "Bayesian NonParametrics"]
bibliography: concentration_parameter.bib
format:
  html:
    toc: true
engine: knitr
...
::: {.callout-note}
## Archival Post
This post originally appeared in December 2019 during my PhD, on an earlier version of this website. It's preserved here largely as-is; some links, code, or context may be out of date. I first encountered this issue while developing the method that would eventually become [@peterson2023close].
:::
